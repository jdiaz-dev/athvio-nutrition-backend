...
MERGE (charcoalRec:Recommendation {name: "Desintoxicación de metales pesados"})
ON CREATE SET charcoalRec.uuid = randomUUID(), charcoalRec.details = "Tomar carbón activado", charcoalRec.isActive = true, charcoalRec.createdAt = datetime(), charcoalRec.updatedAt = datetime() 
