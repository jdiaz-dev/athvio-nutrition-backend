...
import { DiseaseCausesResolver } from 'src/modules/nutrition-builder/disease-causes/adapters/in/diseases.resolver';
import {
  DiseaseCause,
  DiseaseCauseSchema,
} from 'src/modules/nutrition-builder/disease-causes/adapters/out/disease-cause.schema';
