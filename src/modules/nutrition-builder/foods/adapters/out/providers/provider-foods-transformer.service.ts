...
import { Food, FoodsMeta, GetFoodsDto, GetFoodsResponse, Measure } from 'src/modules/nutrition-builder/foods/adapters/in/dtos/get-foods.dto';
import { FoodHint, FoodMeasure, FoodParsedResponse, NextLink } from 'src/modules/nutrition-builder/foods/adapters/out/providers/food.types';
