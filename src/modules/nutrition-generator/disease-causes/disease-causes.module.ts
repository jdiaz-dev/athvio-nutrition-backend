...
import { DiseaseCausesPersistenceService } from 'src/modules/nutrition-generator/disease-causes/adapters/out/disease-cause-persistence.service';
import { DiseaseCausesResolver } from 'src/modules/nutrition-generator/disease-causes/adapters/in/diseases.resolver';
import {
  DiseaseCause,
  DiseaseCauseSchema,
