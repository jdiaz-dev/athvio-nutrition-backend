...
import { DiseaseCausesPersistenceService } from 'src/modules/program-builder/disease-causes/adapters/out/disease-cause-persistence.service';
import { DiseaseCausesResolver } from 'src/modules/program-builder/disease-causes/adapters/in/diseases.resolver';
import {
  DiseaseCause,
  DiseaseCauseSchema,
